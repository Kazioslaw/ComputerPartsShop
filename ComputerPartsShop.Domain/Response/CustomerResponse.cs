namespace ComputerPartsShop.Domain.DTO
{
	...
	public record CustomerWithAddressResponse(Guid Id, string FirstName, string LastName, string? Username, string? Email, string? PhoneNumber, List<AddressResponse> AddressList);
