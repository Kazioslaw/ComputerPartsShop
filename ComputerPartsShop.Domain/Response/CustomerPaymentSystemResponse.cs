...
namespace ComputerPartsShop.Domain.DTO
{
	...
	public record PaymentInCustomerPaymentSystemResponse(Guid Id, int OrderId, decimal Total, PaymentMethod Method, PaymentStatus Status, DateTime PaymentStartAt, DateTime? PaidAt);
}