...
namespace ComputerPartsShop.Services
{
	public class CustomerService : IService<CustomerRequest, CustomerResponse, DetailedCustomerResponse, Guid>
	{
		...
		public async Task<CustomerResponse> Create(CustomerRequest customer)
		{
			...
			var createdCustomerID = await _customerRepository.Create(newCustomer);
		...
		public async Task<CustomerResponse> Update(Guid id, CustomerRequest updatedCustomer)
		{
