...
namespace ComputerPartsShop.Services
{
	public interface IShopUserService
	{
		...
		public Task<TokensResponse> LoginAsync(LoginRequest request, CancellationToken ct);
		public Task<TokensResponse> RefreshTokenAsync(string input, CancellationToken ct);
